...
If you're ready to sart building, [sign up](https://fritz.ai/pricing?utm_source=github&utm_campaign=fritz-examples) for a Fritz AI account to see how you can include machine learning features in your apps.
